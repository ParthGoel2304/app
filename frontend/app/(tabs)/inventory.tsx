...
const styles = StyleSheet.create({
  ...
  emptySub: { fontSize: 14, color: '#5f6368', textAlign: 'center', marginTop: 8, marginBottom: 24 },
  goHomeBtn: {
  ...
  searchInput: { flex: 1, fontSize: 15, color: '#202124' },
  sortBar: {
    flexDirection: 'row', alignItems: 'center',
    paddingHorizontal: 16, paddingVertical: 10, gap: 8,
  },
  sortLabel: { fontSize: 13, color: '#5f6368' },
  sortBtn: {
    paddingHorizontal: 12, paddingVertical: 6,
    borderRadius: 8, backgroundColor: '#fff',
    borderWidth: 1, borderColor: '#e0e0e0',
  },
  sortBtnActive: { backgroundColor: '#E8F0FE', borderColor: '#4285F4' },
  sortBtnText: { fontSize: 12, color: '#5f6368', fontWeight: '500' },
  ...
  itemSize: { fontSize: 16, fontWeight: '700', color: '#202124', flex: 1 },
  stockBadge: {
    flexDirection: 'row', alignItems: 'center',
  ...
  detailValue: { fontSize: 13, fontWeight: '700', color: '#202124', marginTop: 2 },
  // Modal
  modalOverlay: {
