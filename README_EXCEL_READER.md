...
Redirect URI: https://inventory-lookup-app.preview.emergentagent.com/api/oauth/drive/callback
Authorized Origin: https://inventory-lookup-app.preview.emergentagent.com
```
...
```bash
# Test backend
curl https://inventory-lookup-app.preview.emergentagent.com/api/

# Create session
curl -X POST https://inventory-lookup-app.preview.emergentagent.com/api/session/create

# Check status
curl "https://inventory-lookup-app.preview.emergentagent.com/api/drive/status?session_id=YOUR_SESSION_ID"
```
...
GOOGLE_DRIVE_REDIRECT_URI="https://inventory-lookup-app.preview.emergentagent.com/api/oauth/drive/callback"
FRONTEND_URL="https://inventory-lookup-app.preview.emergentagent.com"
```

### Frontend (.env)
```env
EXPO_PUBLIC_BACKEND_URL=https://inventory-lookup-app.preview.emergentagent.com
```
...
**Backend API**: https://inventory-lookup-app.preview.emergentagent.com/api/
