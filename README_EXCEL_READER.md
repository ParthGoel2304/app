...
Redirect URI: https://parchi-quotation.preview.emergentagent.com/api/oauth/drive/callback
Authorized Origin: https://parchi-quotation.preview.emergentagent.com
```
...
```bash
# Test backend
curl https://parchi-quotation.preview.emergentagent.com/api/

# Create session
curl -X POST https://parchi-quotation.preview.emergentagent.com/api/session/create

# Check status
curl "https://parchi-quotation.preview.emergentagent.com/api/drive/status?session_id=YOUR_SESSION_ID"
```
...
GOOGLE_DRIVE_REDIRECT_URI="https://parchi-quotation.preview.emergentagent.com/api/oauth/drive/callback"
FRONTEND_URL="https://parchi-quotation.preview.emergentagent.com"
```

### Frontend (.env)
```env
EXPO_PUBLIC_BACKEND_URL=https://parchi-quotation.preview.emergentagent.com
```
...
**Backend API**: https://parchi-quotation.preview.emergentagent.com/api/
