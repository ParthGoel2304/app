...
Redirect URI: https://smart-excel-reader.preview.emergentagent.com/api/oauth/drive/callback
Authorized Origin: https://smart-excel-reader.preview.emergentagent.com
```
...
```bash
# Test backend
curl https://smart-excel-reader.preview.emergentagent.com/api/

# Create session
curl -X POST https://smart-excel-reader.preview.emergentagent.com/api/session/create

# Check status
curl "https://smart-excel-reader.preview.emergentagent.com/api/drive/status?session_id=YOUR_SESSION_ID"
```
...
GOOGLE_DRIVE_REDIRECT_URI="https://smart-excel-reader.preview.emergentagent.com/api/oauth/drive/callback"
FRONTEND_URL="https://smart-excel-reader.preview.emergentagent.com"
```

### Frontend (.env)
```env
EXPO_PUBLIC_BACKEND_URL=https://smart-excel-reader.preview.emergentagent.com
```
...
**Backend API**: https://smart-excel-reader.preview.emergentagent.com/api/
