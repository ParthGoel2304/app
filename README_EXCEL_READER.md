...
Redirect URI: https://drive-quotation-app.preview.emergentagent.com/api/oauth/drive/callback
Authorized Origin: https://drive-quotation-app.preview.emergentagent.com
```
...
```bash
# Test backend
curl https://drive-quotation-app.preview.emergentagent.com/api/

# Create session
curl -X POST https://drive-quotation-app.preview.emergentagent.com/api/session/create

# Check status
curl "https://drive-quotation-app.preview.emergentagent.com/api/drive/status?session_id=YOUR_SESSION_ID"
```
...
GOOGLE_DRIVE_REDIRECT_URI="https://drive-quotation-app.preview.emergentagent.com/api/oauth/drive/callback"
FRONTEND_URL="https://drive-quotation-app.preview.emergentagent.com"
```

### Frontend (.env)
```env
EXPO_PUBLIC_BACKEND_URL=https://drive-quotation-app.preview.emergentagent.com
```
...
**Backend API**: https://drive-quotation-app.preview.emergentagent.com/api/
