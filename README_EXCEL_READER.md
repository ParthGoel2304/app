...
Redirect URI: https://excel-reader-erp.preview.emergentagent.com/api/oauth/drive/callback
Authorized Origin: https://excel-reader-erp.preview.emergentagent.com
```
...
```bash
# Test backend
curl https://excel-reader-erp.preview.emergentagent.com/api/

# Create session
curl -X POST https://excel-reader-erp.preview.emergentagent.com/api/session/create

# Check status
curl "https://excel-reader-erp.preview.emergentagent.com/api/drive/status?session_id=YOUR_SESSION_ID"
```
...
GOOGLE_DRIVE_REDIRECT_URI="https://excel-reader-erp.preview.emergentagent.com/api/oauth/drive/callback"
FRONTEND_URL="https://excel-reader-erp.preview.emergentagent.com"
```

### Frontend (.env)
```env
EXPO_PUBLIC_BACKEND_URL=https://excel-reader-erp.preview.emergentagent.com
```
...
**Backend API**: https://excel-reader-erp.preview.emergentagent.com/api/
